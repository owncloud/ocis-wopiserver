# [Deprecated] oCIS WOPI server: a proof of concept extension to open office files in ownCloud Infinite Scale
...
Please don't use the oCIS WOPI server for any new projects. You should instead have a look at our current [oCIS with WOPI and Collabora / OnlyOffice setup](https://owncloud.dev/ocis/deployment/ocis_wopi/).
